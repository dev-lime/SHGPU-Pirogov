...
<div class="dashboard">
	...
	<div class="stats-grid">
		<a href="/tk/modules/orders/index.php" class="stat-card-link">
			<div class="stat-card">
		...
		<a href="/tk/modules/orders/index.php?filter=active" class="stat-card-link">
			<div class="stat-card">
		...
		<a href="/tk/modules/orders/index.php?filter=completed" class="stat-card-link">
			<div class="stat-card">
		...
		<?php if (hasPermission('view_all')): ?>
			<a href="/tk/modules/clients/index.php" class="stat-card-link">
				<div class="stat-card">
	...
	<div class="quick-actions">
		...
		<div class="action-buttons">
			...
			<?php if (hasPermission('view_all')): ?>
				<a href="/tk/modules/clients/create.php" class="btn btn-primary">
